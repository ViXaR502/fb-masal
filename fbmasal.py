...
\033[1;91m█████████
\033[1;91m█▄█████▄█      ●▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬●
\033[1;91m█ ▲▲▲▲▲              Mr. ViXaR 502
\033[1;91m█ ▲▲▲▲▲        «----------✧----------»
\033[1;91m█████████   SUBSCRIBE NOW TO MY CHANNELL !!
\033[1;91m ██ ██           FB-v3 by Mr. ViXaR 502
\033[1;93m╔════════════════════════════════════════╗
...
def an():
    ...
    try:
        ...
        os.system('reset')
        print logo
        print 'Silahkankan Follow My Fb Rizky PCI !!'
        time.sleep(2)
        print 'Add Wa Saya : 085659520884'
        time.sleep(2)
        print 'Perhatikan Besar Kecilnya Huruf Cukk!!'
        time.sleep(1)
        os.system('xdg-open  https://m.facebook.com/profile.php ')
        print 'User = Indonesia  dan   Pass = Sejahtera'
        time.sleep(2)
        print 'Masukan User dan Pass nya Kintil!!'
